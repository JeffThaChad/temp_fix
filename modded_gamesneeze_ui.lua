...
do 
    LPH_NO_VIRTUALIZE(function()
        ...
        --local themes = {}
        local theme = {
            accent = Color3.fromHex("#3983df"),
            lightcontrast = Color3.fromHex("#141218"),
            darkcontrast = Color3.fromHex("#0d0b11"),
                    ...
                    do -- Preview Stuff
                        ...
                        do -- Chams
                            for Index = 1, 2 do
                                ...
                                local color = Index == 1 and Color3.fromRGB(57, 131, 223) or Color3.fromRGB(255, 255, 255)
                                --
